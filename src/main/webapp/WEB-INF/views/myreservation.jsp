...
<body>
	...
	<div class="popup_booking_wrapper" style="display: none;">
		...
		<div class="popup_booking refund">
			...
			<div class="pop_bottom_btnarea">
				<div class="btn_gray">
					<a href="javascript:;" class="btn_bottom"><span>아니오</span></a>
				</div>
				<div class="btn_green">
			...
			<!-- 닫기 -->
			<a href="javascript:;" class="popup_btn_close" title="close"> <i
	...
	<script type="rv-template" id="reserv-confirm">
      <article class="card_item">
          <a href="#" class="link_booking_details">
            <div class="card_body">
              <div class="left"></div>
              <div class="middle">
                <div class="card_detail">
                  <em class="booking_number" id="{{reservationInfoId}}">
          ...
          {{#unless cancelYn}}
            {{#unless (isCompleted reservationDate)}}
              <a href="#" class="fn fn-share1 naver-splugin btn_goto_share"
                title="공유하기">
              </a>
            {{/unless}}
          {{/unless}}
