			...
			<div class="ct_wrap">
				...
				<form action="" method="post" id="fileForm"
						...
						<div class="review_rating rating_point">
							<div class="rating">
								...
								<input type="checkbox" name="rating" value="1"
									class="rating_rdo" title="1점" /> <span class="span"></span> <input
									type="checkbox" name="rating" value="2" class="rating_rdo"
									title="2점" /> <span class="span"></span> <input
									type="checkbox" name="rating" value="3" class="rating_rdo"
									title="3점" /> <span class="span"></span> <input
									type="checkbox" name="rating" value="4" class="rating_rdo"
									title="4점" /> <span class="span"></span> <input
									type="checkbox" name="rating" value="5" class="rating_rdo"
					...
					<div class="review_contents write">
						...
						<a href="javascript:;" class="review_write_info"
							<c:if test="${not empty noUser}"> onClick="alert('로그인이 필요합니다.'); location.href='./bookingloginForm'"	</c:if>>
							<span class="middot"> 실 사용자의 리뷰는 상품명의 더 나은 서비스 제공과 다른
								사용자들의 선택에 큰 도움이 됩니다. </span><br /> <span class="middot"> 소중한
								리뷰에 대한 감사로 네이버페이 포인트 500원을 적립해드립니다. </span> <span class="left_space">(단,
								리뷰 포인트는 ID 당 1일 최대 5건까지 지급됩니다.)</span>
						</a>
						<textarea cols="30" rows="12" class="review_textarea"
							name="comment">
              </textarea>
					</div>
					<!-- //리뷰 입력 -->
					...
					<div class="review_write_footer_wrap">
						<div class="review_write_footer">
							<label class="btn_upload" for="reviewImageFileOpenInput">
								...
								id="reviewImageFileOpenInput" name="attachedImage"
						...
						<div class="review_photos review_photos_write">
							<div class="item_preview_thumbs">
								<ul class="lst_thumb">
									<li class="item"><a href="#" class="anchor"> <span
											class="spr_book ico_del">삭제</span>
									</a> <img src="" max-width="100" max-height="80" alt=""
										class="item_thumb" /> <span class="img_border"></span></li>
								</ul>
							</div>
						</div>
						<!-- //리뷰 포토 -->
